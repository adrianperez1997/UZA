...
n		EQU 10						; long=28 (bytes que ocupa serie)
tabla	DCD 4,8,5,9,1,6,2,7,3,0		; serie es una tabla de 7 enteros
		...
		PUSH{r0}					; apilo @tabla
		bl ordena					; SBR ordena
		add sp,sp,#8
fin		b fin
  
ordena	PUSH{lr}					; Apilo lr
		PUSH{r11}					; Apilo r11
		mov fp,sp					; Copio fp=sp
		PUSH{r0,r1}					; Apilo regs que voy a utilizar
		...
		POP{r0,r1}					; Desapilo regs usados
		POP{r11}					; Desapilo r11
		POP{pc}						; Retorno a pc
